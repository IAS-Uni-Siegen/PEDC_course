...
\begin{solutionblock}
    ...
    \begin{equation}
        W_\mathrm{kin}= \frac{1}{2} m_\mathrm{e}v^2 = \frac{1}{2} m_\mathrm{e} r^2 \omega^2.
        \label{eq:Wkinmech}
    \end{equation}
    ...
    \begin{equation}
        m_\mathrm{e} r \omega^2 = \frac{{q_\mathrm{e}}^2}{4\pi\epsilon_0 r^2}
        \label{eq:Wkinelec}
    \end{equation}   
    ...
    \begin{equation}
        \begin{aligned}
            \omega &= \sqrt{\frac{2 \cdot W_\mathrm{kin}}{ m_\mathrm{e} r^2}} = \sqrt{\frac{2 \cdot \SI{2.17 \cdot 10^{-18}}{\joule}}{\SI{9.11 \cdot 10^{-31}}{\kilo\gram} \cdot (\SI{0.0529}{\nano\meter})^2}}
            = \SI{4.13 \cdot 10^{16}}{1\per\second}. \\
            f& = \SI{6.57 \cdot 10^{15}}{hertz}.
        \end{aligned}
    \end{equation}
...
and a mobility $\mu_\mathrm{n}$ of $\SI{1300}{\square{\centi\meter}\per{\volt\second}}$. (The intrinsic conductivity is to neglected.)}
...
\begin{solutionblock}
    ...
    \begin{equation}
        \sigma = nq\mu_\mathrm{n} = \SI{10^{16}}{1\per{\cubic{\centi\meter}}} \cdot \SI{1.60 \cdot 10^{-19}}{\coulomb}
        \cdot \SI{1300}{\square{\centi\meter}\per{\volt\second}} = \SI{2.08}{\frac{1}{\ohm\centi\meter}}.
    \end{equation}
    The resistivity results by the reciprocal value:
    \begin{equation}
        \rho = \frac{1}{\sigma} = \frac{1}{\SI{2.08}{{\ohm\centi\meter}^{-1}}}= \SI{0.48}{\ohm\centi\meter}.
    \end{equation} 
\end{solutionblock}
    ...
    \begin{equation}
        \sigma \approx N_\mathrm{d}q\mu_\mathrm{n}
               \approx  2\cdot \SI{10^{16}}{\cubic{\centi\meter}} \cdot \SI{1.60 \cdot 10^{-19}}{\coulomb} \cdot
                 ...
                 = \SI{4.3}{\frac{1}{\ohm\centi\meter}}.
    \end{equation}
    The resistivity results by the reciprocal value:
    \begin{equation}
        \rho = \frac{1}{\sigma} = \frac{1}{\SI{4.3}{{\ohm\cubic{\centi\meter}}^{-1}}}= \SI{0.23}{\ohm\centi\meter}.
    \end{equation}     
\end{solutionblock}
...
\subtask{Calculate the Hall voltage for a probe current of $\SI{100}{\milli\ampere}$ and a magnetic field perpendicular to the plane of $B= \SI{0.1}{\micro\tesla}$.}
...
\begin{solutionblock}
    ...
    \begin{equation}
        ...
        = \frac{\SI{100}{\milli\ampere} \cdot \SI{0.1}{\micro\tesla}}{\SI{1.60 \cdot 10^{-19}}{\coulomb} \cdot \SI{10^{14}}{\frac{1}{\cubic{\centi\meter}}} \cdot \SI{0.5}{\milli\meter}}
        = \SI{1.25}{\volt} 
    \end{equation} 
\end{solutionblock}    
\vspace{0.5cm}
