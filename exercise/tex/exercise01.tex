...
\begin{solutionblock}
    ...
    \end{equation}
    Using \eqref{eq:hall_voltage} and taking in account, that $N_a = \SI{10^{14}}{\cubic{\centi\meter}} = \SI{10^{20}}{\cubic{\meter}}$ results in
    \begin{equation}
        U_\mathrm{H} = \frac{J_\mathrm{p}}{qp}B_\mathrm{z} l_\mathrm{w} = \frac{I \cdot B_\mathrm{z}}{qpd}
        = \frac{\SI{100}{\milli\ampere} \cdot \SI{0.1}{\tesla}}{\SI{1.60 \cdot 10^{-19}}{\coulomb} \cdot \SI{10^{20}}{\frac{1}{\cubic{\meter}}} \cdot \SI{0.5}{\milli\meter}}
        = \SI{1.25}{\volt} 
    \end{equation} 
\end{solutionblock}    
\vspace{0.5cm}
