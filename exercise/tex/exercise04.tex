...
\begin{solutionblock}
    ...
    \begin{align}
        I_\mathrm{rms} &= I \cdot D = \SI{20}{\ampere} 0.5 = \SI{10}{\ampere} \\
        P_\mathrm{ON,M} &= \left(I_\mathrm{rms}\right)^2 \cdot R_\mathrm{DS(on)} = \left( \SI{10}{\ampere} \right)^2 \cdot \SI{80}{\milli\ohm} = \SI{8}{\watt} \\
        P_\mathrm{sw,M} &\approx \frac{1}{6} V_\mathrm{DS} I_\mathrm{D} (t_\mathrm{r} + t_\mathrm{f}) f_\mathrm{s} =
                          \frac{1}{6} \cdot \SI{400}{\volt} \cdot \SI{20}{\ampere} \cdot \SI{80}{\nano\second} \cdot \SI{80}{\kilo\hertz} = \SI{8.53}{\watt} \\
        P_\mathrm{tot,M} &\approx \SI{16.5}{\watt}.
    \end{align}

    For the IGBT:
    \begin{align}
        P_\mathrm{ON,I} &= \SI{2.1}{\volt} \cdot \SI{20}{\ampere} \cdot 0.5 = \SI{21}{\watt} \\
        P_\mathrm{sw,I} &\approx \SI{1.8}{\milli\joule} \cdot \SI{80}{\kilo\hertz} = \SI{144}{\watt} \\
...
\begin{solutionblock}
    ...
    \begin{align}
        I_\mathrm{rms} &= \SI{50}{\ampere} \cdot 0.5 = \SI{25}{\ampere} \\
        P_\mathrm{ON,M} &= \left( \SI{25}{\ampere} \right)^2 \cdot \SI{180}{\milli\ohm} = \SI{112.5}{\watt}  \\
        P_\mathrm{sw,M} &\approx \frac{1}{6} V_\mathrm{DS} I_\mathrm{D} (t_\mathrm{r} + t_\mathrm{f}) f_\mathrm{s} =
                        \frac{1}{6} \cdot \SI{800}{\volt} \cdot \SI{50}{\ampere} \cdot \SI{80}{\nano\second} \cdot \SI{5}{\kilo\hertz} = \SI{2.7}{\watt} \\
        P_\mathrm{tot,M} &\approx \SI{115}{\watt}.
    \end{align}
    ...
    \begin{align}
        ...
        P_\mathrm{sw,I} &\approx \SI{6}{\milli\joule} \cdot \SI{5}{\kilo\hertz} = \SI{30}{\watt} \\
