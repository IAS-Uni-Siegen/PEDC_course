...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.65\textwidth}
          \begin{itemize}
                \item All matter is made of atoms.
                \item An atom is the smallest unit that retains the properties of an element.
                \item Atomic structure can be described using early classical models and modern quantum models.
                \item In the classical picture, electrons orbit a central nucleus containing protons and neutrons.
                \item In the quantum picture, electrons occupy quantized energy states rather than fixed paths.
                \item In both views, the atom consists of a nucleus surrounded by electrons.
          \end{itemize}
		\end{column}
        \hfill
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.65\textwidth}
          \begin{itemize}
                \item The number of protons in the nucleus defines the element.
                \item Electrons occupy shells or energy levels around the nucleus.
                \item Electrons are negatively charged; protons are positively charged.
                \item In a neutral atom, the number of electrons equals the number of protons.
                \item The outermost shell is called the valence shell.
                \item Valence electrons largely determine bonding and electrical behaviour.
                \item Atoms can gain or lose electrons to form ions.
          \end{itemize}
		\end{column}
        \hfill
		\begin{column}{0.35\textwidth}
...
\begin{frame}
	\frametitle{Ionisation energy}
          \begin{itemize}
                \item Ionisation energy is the energy required to remove an electron from an atom.
                \item It depends on nuclear charge, electron distance from the nucleus, and shielding by other electrons.
                \item Outer-shell electrons are generally easier to remove.
                \item Atoms with low ionisation energy lose electrons more easily.
                \item Ionisation energy strongly influences chemical reactivity and electrical behaviour.
          \end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.6\textwidth}
            \begin{itemize}
                \item The electrical behaviour of materials depends on atomic arrangement and electron bonding.
                \item Carbon has four valence electrons.
                \item Its electrical properties depend strongly on crystal structure.
                \item In diamond, each carbon atom forms four strong covalent bonds, leaving no free electrons.
                \item In graphite, some electrons can move more easily within layered structures.
                \item Therefore, the same element can behave very differently depending on structure.
            \end{itemize}
		\end{column}
        \hfill
...
\begin{frame}
	\frametitle{Materials in electronics}
            ...
            \begin{itemize}
                \item \textbf{Insulators}: electrons are tightly bound (\textbf{very high ionisation energy}), so conductivity is very low. Examples: rubber, glass, plastic. \vspace{2pt}
                \item \textbf{Conductors}: many electrons move easily (\textbf{low ionisation energy}), so conductivity is high. Examples: metals like copper (Cu) and aluminum (Al). \vspace{2pt}
                \item \textbf{Semiconductors*}: conductivity lies between insulators and conductors and can be controlled by doping, temperature, or light. Examples: Silicon (Si) and Germanium (Ge) as intrinsic and gallium arsenide, indium phosphide, gallium nitride, silicon carbide are extrinsic.
            \end{itemize}
            \end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{How mobility and diffusion are related for charge carriers?}
    \begin{itemize}
