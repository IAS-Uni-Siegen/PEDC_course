...
The course will be in 6 modules.
		...
		\end{itemize}
\textbf{Pattern of class}: \\ Day: Wednesday, every week \\ 
Time: 1400 to 1600 (theory) and 1600 to 1800 (tutorial) (ideally but it can change) \\
Holidays: None, but classes will be rescheduled, as needed. 
\end{frame}
...
\centering
	...
	\begin{varblock}{Contact}
		\begin{itemize}
			\item Email: see \href{https://www.uni-siegen.de/en/ias}{chair's homepage}
			\item Offices: H-A building, 4th floor
			\item Individual appointments on request (remote or personally)
            \item Multiple relevant courses are offered by the Chair.  \href{https://www.uni-siegen.de/en/ias-teaching-fac-iv/eti/networked-automation-systems}{Check link!}
		\end{itemize}
	\end{varblock}
...
\begin{frame}
	...
	\begin{itemize}
		\item Explain the role of power electronics in modern energy systems and electrification.
		\item Describe the operating principles of key power electronic devices and components.
		\item Analyse semiconductor fundamentals: band theory, carrier transport, junction behaviour, and breakdown.
		\item Compare the structures, characteristics, and operation of major power semiconductor devices.
		\item Interpret switching, conduction, and thermal limits of Si, SiC, and GaN devices.
		\item Select and model passive components such as capacitors, inductors, transformers, and filters.
	\end{itemize}
\end{frame}
