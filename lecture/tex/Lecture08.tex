...
\small
* -- also known as the loss tangent or dissipation factor—measures a capacitor's internal energy loss. It is the ratio of resistive (wasted) power to reactive (stored) power. A lower $\tan\delta^*$ means a more efficient capacitor with minimal energy lost as heat.
\end{frame}
