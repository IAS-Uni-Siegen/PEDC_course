...
\include{tex/Lecture07} % Passive components - Magnetics
\include{tex/Lecture08} % Passive components - Capacitors
%\include{tex/Lecture08} % Introduction to power module packaging, reliability, and testing, and thermal management
